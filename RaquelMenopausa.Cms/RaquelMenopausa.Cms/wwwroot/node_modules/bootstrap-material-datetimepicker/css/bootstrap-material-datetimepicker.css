...
.dtp > .dtp-content > .dtp-date-view > header.dtp-header { background: #d81c1c; color: #fff; text-align: center; padding: 0.3em; }

.dtp div.dtp-date, .dtp div.dtp-time { background: #f53333; text-align: center; color: #fff; padding: 10px; }
...
.dtp table.dtp-picker-days tr > td > a.selected{ background: #f53333; color: #fff; }
...
.dtp .dtp-actual-meridien a.selected { background: #f53333; color: #fff; }
